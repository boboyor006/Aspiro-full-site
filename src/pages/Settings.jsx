...
const Settings = () => {
  return (
    <div className='Cantac'>
                ...
                <span className="hint-radius"></span>
                    <span className="hint-dot">
                        ...
                        <div className="hint-content do--split-children">
                            <p>Manzil: DENOV TUMANI SHAROF RASHIDOV KO'CHASI 265-UY MO'LJAL: ECOBOG' (sobiq DENDRARIY) RO'PARASIDAGI BINO 3-QAVAT</p>
                </div>
            </div>
        </div>
        ...
        <h1 className='tels' ><i className='bx bx-mobile-alt'> +998 99 713 10 02</i></h1>
        <h1 className='telss' ><i className='bx bx-message' ><a href="https://t.me/aspiroworld">   Aspiro</a></i></h1>
        <h1 className='telss' ><i className='bx bxs-chat' ><a href="https://mail.google.com/mail/u/0/#sent">  polatovt033@gmail.com</a></i></h1>
